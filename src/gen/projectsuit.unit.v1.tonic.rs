        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/projectsuit.unit.v1.UnitService/CreateUnit",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("projectsuit.unit.v1.UnitService", "CreateUnit"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/projectsuit.unit.v1.UnitService/UpdateUnit",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("projectsuit.unit.v1.UnitService", "UpdateUnit"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/projectsuit.unit.v1.UnitService/DeleteUnit",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("projectsuit.unit.v1.UnitService", "DeleteUnit"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/projectsuit.unit.v1.UnitService/GetUnit",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("projectsuit.unit.v1.UnitService", "GetUnit"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/projectsuit.unit.v1.UnitService/ListUnits",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("projectsuit.unit.v1.UnitService", "ListUnits"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod unit_service_server {
    ...
    pub trait UnitService: Send + Sync + 'static {
        ...
        async fn update_unit(
            &self,
            request: tonic::Request<super::UpdateUnitRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::common::v1::MutateResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/projectsuit.unit.v1.UnitService/UpdateUnit" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateUnitSvc<T: UnitService>(pub Arc<T>);
                    impl<
                        T: UnitService,
                    > tonic::server::UnaryService<super::UpdateUnitRequest>
                    for UpdateUnitSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UnitService>::update_unit(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateUnitSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/projectsuit.unit.v1.UnitService/DeleteUnit" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteUnitSvc<T: UnitService>(pub Arc<T>);
                    impl<
                        T: UnitService,
                    ...
                    > for DeleteUnitSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UnitService>::delete_unit(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteUnitSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: UnitService> tonic::server::NamedService for UnitServiceServer<T> {
        const NAME: &'static str = "projectsuit.unit.v1.UnitService";
    }
}
