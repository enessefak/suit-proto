        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "projectsuit.order.v1.OrderCommandService",
                        "CreateOrder",
                    ),
                );
...
pub mod order_command_service_server {
    ...
    #[async_trait]
    pub trait OrderCommandService: Send + Sync + 'static {
        ///
    ...
    ///
    #[derive(Debug)]
    pub struct OrderCommandServiceServer<T: OrderCommandService> {
        inner: Arc<T>,
    ...
    impl<T: OrderCommandService> OrderCommandServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: OrderCommandService> Clone for OrderCommandServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: OrderCommandService> tonic::server::NamedService
    for OrderCommandServiceServer<T> {
        const NAME: &'static str = "projectsuit.order.v1.OrderCommandService";
    }
}
/// Generated client implementations.
pub mod order_query_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("projectsuit.order.v1.OrderQueryService", "GetOrder"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod order_query_service_server {
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/projectsuit.order.v1.OrderQueryService/GetOrder" => {
                    #[allow(non_camel_case_types)]
                    struct GetOrderSvc<T: OrderQueryService>(pub Arc<T>);
                    impl<
                        T: OrderQueryService,
                    ...
                    for GetOrderSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OrderQueryService>::get_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    for OrderQueryServiceServer<T> {
        const NAME: &'static str = "projectsuit.order.v1.OrderQueryService";
    }
}
